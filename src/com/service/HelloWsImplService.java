 ...
 * 
 */
@WebServiceClient(name = "HelloWsImplService", targetNamespace = "http://service.com/", wsdlLocation = "http://localhost:8087/webservice/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://service.com/", "HelloWsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8087/webservice/hello?wsdl");
    ...
    public HelloWsImpl getHelloWsImplPort() {
        return super.getPort(new QName("http://service.com/", "HelloWsImplPort"), HelloWsImpl.class);
    }
    ...
    public HelloWsImpl getHelloWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.com/", "HelloWsImplPort"), HelloWsImpl.class, features);
    }
